...
class Authorization(QMainWindow):
    ...
    def AddRequestButfunction(self):
        ...
        self.IDrequestLine = self.findChild(QTableWidget,'IDrequestLine')
        self.startDateLine = self.findChild(QTableWidget,'startDateLine')
        self.orgTechTypeIDLine = self.findChild(QTableWidget,'orgTechTypeIDLine')
        self.orgTechModelLine = self.findChild(QTableWidget,'orgTechModelLine')
        self.problemDescryptionLine = self.findChild(QTableWidget,'problemDescryptionLine')
        self.requestStatusIDLine = self.findChild(QTableWidget,'requestStatusIDLine')
        self.completionDateLine = self.findChild(QTableWidget,'completionDateLine')
        self.repairPartsLine = self.findChild(QTableWidget,'repairPartsLine')
        self.masterIDLine = self.findChild(QTableWidget,'masterIDLine')
        self.clientIDLine = self.findChild(QTableWidget,'clientIDLine')
